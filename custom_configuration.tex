...
\title{Quantitative Assessment of Flow-Based Market Coupling versus Available Transfer Capacity for the Nordic Electricity Market}
\subtitle{A Comparative Analysis of Capacity Allocation Methods}

% give the alternative title - i.e., if the thesis is in English, then give a Swedish title
\alttitle{Kvantitativ utvärdering av flödesbaserad marknadskoppling jämfört med tillgänglig överföringskapacitet för den nordiska elmarknaden}
\altsubtitle{En jämförande analys av kapacitetsallokeringsmetoder}
...
\courseCode{EL2810} % fill in your course code
\courseCredits{30.0} % typically: \courseCredits{15.0} or \courseCredits{30.0}

% Fill in your program code
\programcode{TELPM}         % or \programcode{CXXXX}
\degreeName{Degree of Master of Science in Engineering} % \degreeName{Bachelors degree} or \degreeName{Degree of Master of Science in Engineering}
...
% --- Author Information ---
\authorsLastname{Palmborg}
\authorsFirstname{Simon}
\email{spalmborg@kth.se}
%\kthid{u1XXXXXX}
...
\supervisorAsLastname{Hesamzadeh}
\supervisorAsFirstname{Mohammad Reza}
\supervisorAsEmail{mrhesamzadeh@kth.se}
% If the supervisor is from within KTH add their KTHID, School and Department info
%\supervisorAsKTHID{u1XXXXXX}
\supervisorAsSchool{\schoolAcronym{EECS}}
\supervisorAsDepartment{Electric Power and Energy Systems}
...
% TODO: Replace with actual examiner name before final submission
\examinersLastname{[Examiner]}
\examinersFirstname{[Name]}
\examinersEmail{examiner@kth.se}
% If the examiner is from within KTH add their KTHID, School and Department info
%\examinersKTHID{u1XXXXXX}
\examinersSchool{\schoolAcronym{EECS}}
\examinersDepartment{Electric Power and Energy Systems}
...
\nationalsubjectcategories{20299, 20203}
