...
\supervisorAsLastname{Mohammadi}
\supervisorAsFirstname{Saeed}
\supervisorAsEmail{saeedmoh@kth.se}
...
\examinersLastname{Hesamzadeh}
\examinersFirstname{Mohammad Reza}
\examinersEmail{mrhesa@kth.se}
