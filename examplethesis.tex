...
The central finding is that FBMC provides measurable and economically significant efficiency gains over ATC, but these gains are neither uniform nor guaranteed. Under winter conditions with high north-south congestion, FBMC achieves cost savings of 6.5\% compared to ATC---a substantial improvement that validates the Nordic region's decision to implement flow-based allocation. However, during summer periods with low demand and minimal congestion, FBMC benefits shrink to just 0.25\%, representing a fifty-fold seasonal variation. This pattern reveals that FBMC is not a universal improvement but rather a tool whose value is contingent on system conditions.
...
% This page contains metadata for archiving in DiVA (Digitala Vetenskapliga Arkivet).
% It will be removed from the final published version.

\begin{tabular}{@{}p{4.5cm}p{10cm}@{}}
\toprule
\textbf{Field} & \textbf{Data} \\
\midrule
\multicolumn{2}{l}{\textbf{Author Information}} \\
\midrule
Author Name & Simon Palmborg \\
KTH User ID & [your KTH username] \\
Email & [your @kth.se email] \\
Programme & Master's Programme, Electric Power Engineering \\
School & School of Electrical Engineering and Computer Science (EECS) \\
\midrule
\multicolumn{2}{l}{\textbf{Thesis Information}} \\
\midrule
Title (English) & Quantitative Assessment of Flow-Based Market Coupling versus Available Transfer Capacity for the Nordic Electricity Market \\
Title (Swedish) & Kvantitativ bedömning av flödesbaserad marknadskoppling jämfört med tillgänglig överföringskapacitet för den nordiska elmarknaden \\
Subtitle & A Simulation Study of Capacity Allocation Efficiency \\
TRITA Number & TRITA-EECS-EX-2025:XXX \\
\midrule
\multicolumn{2}{l}{\textbf{Supervision}} \\
\midrule
Supervisor (KTH) & Mohammad Reza Hesamzadeh \\
Examiner & [Examiner Name] \\
External Supervisor & N/A \\
\midrule
\multicolumn{2}{l}{\textbf{Keywords}} \\
\midrule
English Keywords & Flow-Based Market Coupling, Available Transfer Capacity, Nordic electricity market, PTDF, market efficiency, transmission capacity allocation, welfare analysis \\
Swedish Keywords & Flödesbaserad marknadskoppling, tillgänglig överföringskapacitet, nordisk elmarknad, PTDF, marknadseffektivitet, överföringskapacitetsallokering, välfärdsanalys \\
\midrule
\multicolumn{2}{l}{\textbf{Defense}} \\
\midrule
Presentation Date & [Date of oral presentation] \\
Opponent & [Name of opponent] \\
Location & [Room/Zoom link] \\
\midrule
\multicolumn{2}{l}{\textbf{Abstract (English)}} \\
\midrule
\multicolumn{2}{p{14.5cm}}{\small This thesis quantitatively compares Flow-Based Market Coupling (FBMC) and Available Transfer Capacity (ATC) methods for the Nordic electricity market. Using a 13-node zonal model with empirical data from the Swedish transmission system, simulations demonstrate that FBMC achieves 6.5\% cost savings under winter congestion conditions, equivalent to €4.37 million weekly. Benefits exhibit strong seasonal variation, ranging from 12.6\% in January to 0.25\% in July, correlating with transmission utilization on the critical SE2--SE3 corridor. Sensitivity analysis confirms that benefits amplify under system stress (16.1\% with reduced capacity) and disappear entirely under price convergence. The physical mechanism enabling FBMC benefits is identified as loop flow exploitation through Norwegian interconnections. Results align with Nordic RCC External Parallel Run data, validating the model's economic accuracy.} \\
\midrule
\multicolumn{2}{l}{\textbf{Sammanfattning (Swedish)}} \\
\midrule
\multicolumn{2}{p{14.5cm}}{\small Denna uppsats jämför kvantitativt flödesbaserad marknadskoppling (FBMC) och tillgänglig överföringskapacitet (ATC) för den nordiska elmarknaden. Med hjälp av en 13-nodsmodell och empiriska data från det svenska transmissionsnätet visar simuleringar att FBMC uppnår 6,5\% kostnadsbesparingar under vinterförhållanden med hög belastning, motsvarande 4,37 miljoner euro per vecka. Fördelarna uppvisar stark säsongsvariation, från 12,6\% i januari till 0,25\% i juli, korrelerat med utnyttjandegraden på den kritiska SE2--SE3-korridoren. Känslighetsanalys bekräftar att fördelarna förstärks under systemstress (16,1\% vid reducerad kapacitet) och försvinner helt vid priskonvergens. Den fysiska mekanismen som möjliggör FBMC-fördelar identifieras som utnyttjande av kretskraftsflöden genom norska sammanlänkningar.} \\
\bottomrule
\end{tabular}

\vfill
\noindent\textit{Note: This page is for administrative purposes only and will be removed from the published version.}
